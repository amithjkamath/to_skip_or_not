...
class Net(pytorch_lightning.LightningModule):
    ...
    def prepare_data(self):
        ...
        train_files, val_files = data_dicts[:14], data_dicts[14:17]
        ...
        train_transforms = Compose(
            [
                ...
                RandCropByPosNegLabeld(
                    keys=["image", "label"],
                    label_key="label",
                    spatial_size=(PATCH_SIZE, PATCH_SIZE, 32),
                    pos=1,
                    neg=1,
                    num_samples=4,
                    image_key="image",
...
def main():
    ...
    repo_root = "/Users/amithkamath/repo/to_skip_or_not"
    eventid = datetime.now().strftime('-%Y%m-%d%H-%M%S')
    log_dir = os.path.join(repo_root, "logs" + eventid)

    data_root = "/Users/amithkamath/data/MSD"
    data_dir = os.path.join(data_root, "Task02_Heart")
