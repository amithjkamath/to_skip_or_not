...
def prepare_data(source_dir, dest_dir):
    ...
    valid_imgs = all_imgs[25:30]
    valid_labels = all_labels[25:30]
    ...
    test_imgs = all_imgs[30:]
    test_labels = all_labels[30:]
...
if __name__ == "__main__":
    ...
    source_dir = os.path.join(root_dir, "Task09_Spleen")
    destination_dir = os.path.join(root_dir, "Task09_Spleen-processed")
