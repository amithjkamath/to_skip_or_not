...
def main():
    ...
    data_dir = os.path.join(
        root_dir, "data_noshare", "train", "clinical", "Heart-processed"
    )
    ...
    for seed_num in seed_list:
        for swin_size in swin_list:
            for net in net_name:
                ...
                train_df = pd.read_csv(os.path.join(data_dir, "Heart_stats_train.csv"))
                ...
                valid_df = pd.read_csv(os.path.join(data_dir, "Heart_stats_valid.csv"))
                ...
                test_df = pd.read_csv(os.path.join(data_dir, "Heart_stats_test.csv"))
                ...
                project = "heart-" + net + "-full-v3"
                project_name = net + "_" + str(swin_size) + "_" + str(seed_num)
                output_folder = os.path.join(
                    root_dir, "reports", "heart-v3", project_name
                )
